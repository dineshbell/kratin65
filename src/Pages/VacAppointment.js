  ...
  <form onSubmit={handleSubmit} className="vac-appointment-form mt-5">
    <div className="row">
      <div className="col-sm-12">
        ...
        <img src="https://i.ibb.co/4d9W6qY/check.jpg" className="img-fluid" alt=""/>
...
Such products, information and technologies for self-care â€“ or self-care interventions â€“ can include high-quality medicines, devices, tools to test and diagnose, and digital tools. They can be provided within or outside of a health-care facility, with or without the support of a health worker.
...
â€œWith these new guidelines it is our sincere hope that the essential role people play in managing their own health is further acknowledged and promoted through a supportive health system,â€ says Manjulaa Narasimhan, scientist at WHO Department of Sexual and Reproductive Health and Research including the special joint-UN programme HRP.

â€œWhether itâ€™s for their experience of pregnancy and childbirth; managing fertility intentions, preventing sexually transmitted infections; enjoying better sexual health of themselves or their partner, or self-monitoring their blood pressure, access to quality self-care interventions can help meet peopleâ€™s many health needs and rights.â€

New recommendations and good practice statements
The new guidelines consolidate both new and existing recommendations on self-care interventions which can help to meet the health needs for people worldwide â€“ and particularly in settings with the fewest resources and least infrastructure.

New recommendations include:

Over-the counter pharmacy provision of pregnancy self-tests;

pharmacy access to emergency contraception (or â€œthe morning-after pillâ€)
