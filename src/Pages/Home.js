...
import Vac from '../properties/properties/images/vac.png';
import Demand from '../properties/properties/images/demand.png';
import Appoint from '../properties/properties/images/appoint.png';
// import "./index.css"
...
function Home(){
    return(
        ...
        <div className="container ">
          ...
          <p>Wellbeing = We Treat + the state of being comfortable, healthy, or happy</p>
          <div>
...
molestiae quas vel sint commodi repudiandae consequuntur voluptatum laborum</p>
                  ...
                  <div className="col-md-4 section-one-content">
                      ...
                      <div className="card-content">
                      <h2>Appointments</h2>
                      <p>For primary care & selected specialties, see provider schedules & make your own appointment online, even if youâ€™re new.</p>
