...
import Logo from '../properties/properties/images/health.png';
        ...
        <div className="container">
          ...
          <li><Link to="/">family practice clinic</Link></li>
            ...
            <div className="copyright mt-5">
                ...
                <p>@{dateObj.startYear}-{dateObj.currentYear}<a href="linkedin.com/in/bellam-dinesh-56103a124"> Bellam Dinesh</a>. All rights reserved.</p>
            </div>
        </div>
    </div>
</footer>
